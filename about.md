...
_{{ site.title }}_ is intentionally basic, a sorta mental note to myself not to write as if I'm submitting for publication. The name is derived from Claire Denis' 2001 vampire flick "Trouble Every Day."
